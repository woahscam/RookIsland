...
public final class Kurask extends MobRewardNodeBuilder {
	...
	public void populate(Player player) {
		...
		case COMMON:
			...
			dissectNodeBatch(1, node(BROAD_TIPPED_BOLTS, 1, 10), 
			...
			break;
		case UNCOMMON:
			dissectNodeBatch(1, node(NATURE_RUNE, 5, 30), 
					node(DEATH_RUNE, 1, 6), 
					node(MIND_RUNE, 4, 16), 
			...
			break;
		case RARE:
			dissectNodeBatch(1, node(RUNE_LONGSWORD, 1), 
			...
			break;
		case VERY_RARE:
			dissectNodeBatch(1, node(LEAF_BLADED_SWORD, 1), 
