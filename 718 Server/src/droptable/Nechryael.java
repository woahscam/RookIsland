...
public final class Nechryael extends MobRewardNodeBuilder {
	...
	public void populate(Player player) {
		...
		case -1:
		case COMMON:
			dissectNodeBatch(1, node(STEEL_2H_SWORD, 1), 
			...
			break;
		case UNCOMMON:
			dissectNodeBatch(1, node(RUNE_FULL_HELM, 1), 
			...
			break;
		case RARE:
			dissectNodeBatch(1, node(DWARF_WEED_SEED, 1), 
					node(LANTADYME_SEED, 1), 
					node(RUNITE_BAR, 1));
			break;
		case VERY_RARE:
			dissectNodeBatch(1, node(RUNE_SQ_SHIELD, 1), 
