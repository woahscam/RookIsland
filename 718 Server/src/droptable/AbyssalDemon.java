...
public final class AbyssalDemon extends MobRewardNodeBuilder {
	...
	public void populate(Player player) {
		...
		case -1:
		case COMMON:
			dissectNodeBatch(1, node(BLACK_SWORD, 1), 
					node(BLACK_AXE, 1), 
			...
			break;
		case UNCOMMON:
			dissectNodeBatch(1, node(MITHRIL_KITESHIELD, 1), 
			...
			break;
		case RARE:
			dissectNodeBatch(1, node(ABYSSAL_WHIP, 1), 
					node(RUNE_SQ_SHIELD, 1));
			break;
		case VERY_RARE:
			dissectNodeBatch(1, node(ABYSSAL_HEAD, 1), 
