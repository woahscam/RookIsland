...
public final class HillGiant extends MobRewardNodeBuilder {
	...
	public void populate(Player player) {
		...
		case -1:
		case COMMON:
			dissectNodeBatch(1, node(IRON_ARROW, 3), 
					node(IRON_DAGGER, 1), 
			...
			break;
		case VERY_RARE:
			dissectNodeBatch(1, node(STEEL_PLATEBODY, 1), 
			...
			break;
		case RARE:
			dissectNodeBatch(1, node(IRON_2H_SWORD, 1), 
			...
			break;
		case UNCOMMON:
			dissectNodeBatch(1, node(STEEL_ARROW, 10, 15), 
