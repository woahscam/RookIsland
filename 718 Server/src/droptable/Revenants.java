...
public final class Revenants extends MobRewardNodeBuilder {
	...
	public void populate(Player player) {
		...
		case VERY_RARE:
		case RARE:
			dissectNodeBatch(1, node(14876 + Utils.getRandom(15), 1), node(13958 + Utils.getRandom(10) * 3, 1),
			...
			break;
		case UNCOMMON:
			dissectNodeBatch(1, node(1163, 1), node(1127, 1), node(1079, 1), node(1201, 1), node(1347, 1),
