...
public final class AberrantSpectre extends MobRewardNodeBuilder {
	...
	public void populate(Player player) {
		...
		case COMMON:
			if (Utils.random(2) == 0)
			dissectNodeBatch(3, node(GRIMY_GUAM, 1), 
				...
				dissectNodeBatch(1, node(BELLADONNA_SEED, 1), 
						node(CACTUS_SEED, 1), 
		...
		case UNCOMMON:
			...
			break;
		case RARE:
			dissectNodeBatch(1, node(SNAPDRAGON_SEED, 1), 
			...
			break;
		case VERY_RARE:
			dissectNodeBatch(1, node(GRIMY_SNAPDRAGON, 1, 2));
			break;
		}
