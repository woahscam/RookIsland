...
public final class BronzeDragon extends MobRewardNodeBuilder {
	...
	public void populate(Player player) {
		...
		case -1:
		case COMMON:
			dissectNodeBatch(1, nodeB(ADAMANT_JAVELIN, 30, 60), 
					nodeB(LAW_RUNE, 10, 45), 
					node(COINS, 168, 3000));
			break;
		case UNCOMMON:
			dissectNodeBatch(1, node(ADAMANT_DART, 16), 
					node(MITHRIL_AXE, 1), 
			...
			break;
		case RARE:
			dissectNodeBatch(1, node(RUNE_JAVELIN, 1), 
			...
			break;
		case VERY_RARE:
			dissectNodeBatch(1, node(RUNE_2H_SWORD, 1), 
