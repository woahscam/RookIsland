...
public class NPCSpawnsDumper {
	...
	public static final void main(String[] args) throws IOException {
		BufferedWriter out = new BufferedWriter(new FileWriter("data/npcSpawnDump/unpackedSpawnsList.txt", true));
		Logger.log("Launcher", "Initing Cache...");
		Cache.init();
		Logger.log("Launcher", "Initing Data File...");
		MapArchiveKeys.init();
		for (int regionId = 0; regionId < 20000; regionId++) {
			if (new File("data/npcSpawnDump/packedSpawns/" + regionId + ".ns").exists())
				continue;
