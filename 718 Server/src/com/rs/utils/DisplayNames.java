...
public final class DisplayNames {
	...
	public static boolean Unavailable(Player player, String name) {
		return ((SerializableFilesManager.containsPlayer(Utils.formatPlayerNameForProtocol(name))) || cachedNames.contains(name)
				|| SerializableFilesManager.containsPlayer(name) || Utils.invalidAccountName(name));
	}
