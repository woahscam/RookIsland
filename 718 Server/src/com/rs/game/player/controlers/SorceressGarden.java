...
public class SorceressGarden extends Controler {
	...
	@Override
	public void start() {
		OldMagicSystem.sendNormalTeleportSpell(player, 0, 0, new WorldTile(new WorldTile(2916, 5475, 0), 2));
	}
	...
	public boolean processObjectClick1(WorldObject object) {
		if (object.getId() == 21764) {
			...
			WorldTasksManager.schedule(new WorldTask() {
				...
				public void run() {
					player.reset();
					OldMagicSystem.sendNormalTeleportSpell(player, 0, 0, new WorldTile(3321, 3141, 0));
					removeControler();
				}
