...
public class SawmillController extends Controler {
	...
	public void cutPlank(int type, int amount) {
		player.closeInterfaces();
		//TODO player.getActionManager().setAction(new CutPlank(type, amount, this));
	}
	...
	public boolean processObjectClick1(final WorldObject object) {
		...
		if (object.getId() == 46297) {//take logs
			...
			//TODO player.getActionManager().setAction(new StackOfLogs(Integer.MAX_VALUE));
			return false;
		}
		if (object.getId() == 46304) {
			...
			//TODO player.getActionManager().setAction(new ConveyorBeltHopper(Integer.MAX_VALUE, this));
			return false;
		}
		if (object.getId() == 46309) {
			...
			//TODO player.getActionManager().setAction(new PlanksTake(Integer.MAX_VALUE, this));
			return false;
		}
	...
	public boolean processObjectClick2(final WorldObject object) {
		...
		if (object.getId() == 46297) {//take logs
			...
			//TODO player.getActionManager().setAction(new StackOfLogs(1));
			return false;
		}
		if (object.getId() == 46304) {
			if (!hasJob()) {
			...
			//TODO player.getActionManager().setAction(new ConveyorBeltHopper(1, this));
			return false;
		}
		if (object.getId() == 46309) {
			if (!hasJob()) {
			...
			//TODO player.getActionManager().setAction(new PlanksTake(1, this));
			return false;
		}
		return true;
	}
	...
	private void refreshConveyorAnimation() {
		if (WorldThread.LAST_CYCLE_CTM > lastLogAnimation + 5) {
