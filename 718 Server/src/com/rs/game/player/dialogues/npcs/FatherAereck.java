	...
	public void run(int interfaceId, int componentId) {
		if (stage == -1) {
			...
			if (componentId == OPTION_1)
				OldMagicSystem.sendNormalTeleportSpell(player, 0, 0, new WorldTile(3182, 5713, 0));
			if (componentId == OPTION_2)
				OldMagicSystem.sendNormalTeleportSpell(player, 0, 0, new WorldTile(2157, 3862, 0));
			if (componentId == OPTION_3)
				OldMagicSystem.sendNormalTeleportSpell(player, 0, 0, new WorldTile(3233, 9313, 0));
