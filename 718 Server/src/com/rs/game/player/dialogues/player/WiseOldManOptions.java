...
public class WiseOldManOptions extends Dialogue {
	...
	public void teleport(int i) {
		...
		case 1:// Gnome Agility
			OldMagicSystem.sendObjectTeleportSpell(player, false, new WorldTile(2471, 3437, 0));
			break;
		case 2:// Barbarian Agility
			OldMagicSystem.sendObjectTeleportSpell(player, false, new WorldTile(2542, 3569, 0));
			break;
		/*
		 ...
		 */
		case 4:// Ess mine
			OldMagicSystem.sendObjectTeleportSpell(player, false, new WorldTile(2911, 4833, 0));
			break;
		case 5:// fally mine
			OldMagicSystem.sendObjectTeleportSpell(player, false, new WorldTile(3061, 3373, 0));
			break;
		case 6:// lrc
			OldMagicSystem.sendObjectTeleportSpell(player, false, new WorldTile(3655, 5113, 0));
			break;
