...
public class LowLevelTeleports extends Dialogue {
	...
	private void teleport(String key) {
		...
		case "cows":
			OldMagicSystem.sendObjectTeleportSpell(player, false, new WorldTile(3256, 3266, 0));
			break;
		case "rcs":// rock crabs
			OldMagicSystem.sendObjectTeleportSpell(player, false, new WorldTile(2674, 3696, 0));
			break;
		case "hills":// hill giants
			OldMagicSystem.sendObjectTeleportSpell(player, false, new WorldTile(3115, 3450, 0));
			break;
		case "experiments":
			OldMagicSystem.sendObjectTeleportSpell(player, false, new WorldTile(3555, 9946, 0));
			break;
		case "fires":// fire giants
			OldMagicSystem.sendObjectTeleportSpell(player, false, new WorldTile(2575, 9862, 0));
			break;
		case "ogres":
			OldMagicSystem.sendObjectTeleportSpell(player, false, new WorldTile(2480, 2882, 0));
			break;
		/*
