...
/*		if (hasUnlockedItem(player, item)) {
		...
		if (toUnlock != null) {
			if (player.getInventory().getNumberOf(18201) >= toUnlock.getPrice()) {
				...
				//player.setPKP(player.getPKP() - toUnlock.getPrice());
				/*player.getPackets().sendGameMessage(
						"You unlocked " + defs.getName() + ".<br>You now have " + player.getPKP() + " pk points left.");*/
				...
				/*player.getPackets().sendGameMessage("To unlock this item you need at least " + toUnlock.getPrice()
						+ " pk points." + "<br>You still need another " + modulus + " pk points to unlock this item.");*/
			}
		}
	}
