...
public final class Pet extends NPC {
	...
	public void pickup() {
		if (owner.getPet().getId() != Pets.ABYSSAL_MINION.getBabyNpcId()
				&& owner.getPet().getId() != Pets.GRAARDOR.getBabyNpcId()
				&& owner.getPet().getId() != Pets.KREEARRA.getBabyNpcId()
				&& owner.getPet().getId() != Pets.KRIL.getBabyNpcId()
				&& owner.getPet().getId() != Pets.DARK_BEAST_JR.getBabyNpcId()
				&& owner.getPet().getId() != Pets.BABY_DRAGON.getBabyNpcId()
				&& owner.getPet().getId() != Pets.BABY_DRAGON_1.getBabyNpcId()
				&& owner.getPet().getId() != Pets.BABY_DRAGON_2.getBabyNpcId()
				&& owner.getPet().getId() != Pets.BABY_DRAGON_3.getBabyNpcId()
				&& owner.getPet().getId() != Pets.ZYLYANA.getBabyNpcId()
				&& owner.getPet().getId() != Pets.KALPHITE_PRINCESS.getBabyNpcId()
				&& owner.getPet().getId() != Pets.KALPHITE_PRINCESS_2.getBabyNpcId()
				&& owner.getPet().getId() != Pets.CHAOS_ELEMENTAL_JR.getBabyNpcId()
				&& owner.getPet().getId() != Pets.TORMENTED_DEMON_JR.getBabyNpcId()
				&& owner.getPet().getId() != Pets.ICE_STRYKEWYRM_JR.getBabyNpcId()
				&& owner.getPet().getId() != Pets.DESERT_STRYKEWYRM_JR.getBabyNpcId()
				&& owner.getPet().getId() != Pets.JUNGLE_STRYKEWYRM_JR.getBabyNpcId()
				&& owner.getPet().getId() != Pets.CORPOREAL_PUPPY.getBabyNpcId()
				&& owner.getPet().getId() != Pets.PRINCE_BLACK_DRAGON.getBabyNpcId()
				&& owner.getPet().getId() != Pets.JUNGLE_STRYKEWYRM_JR.getBabyNpcId())
