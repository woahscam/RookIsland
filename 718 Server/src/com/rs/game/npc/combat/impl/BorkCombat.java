...
public class BorkCombat extends CombatScript {
	...
	public int attack(NPC npc, Entity target) {
		 ...
		 * Player player = (Player) target; npc.setNextForceTalk(new ForceTalk(
		 * "Come to my aid, brothers!"));
		...
		delayHit(npc, 0, target, getRegularHit(npc, getRandomMaxHit(npc, cdef.getMaxHit(), -1, target)));
		return 7;// cdef.getAttackDelay();
	}
