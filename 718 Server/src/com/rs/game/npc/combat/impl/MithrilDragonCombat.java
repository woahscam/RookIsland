	...
	public int attack(NPC npc, Entity target) {
		...
		if (withinMeleeDist) {
			...
			case 2:// Melee
				...
				System.out.println("[MithrilDragons] Melee attack init test");
				break;
			case 3:// Close range dragonfire ratio is about 1:5
				...
				System.out.println("[MithrilDragons] Close ranged D-FIRE");
				break;
			case 4:// Ranged Attack 1:5
				...
				System.out.println("[MithrilDragons] Ranged attack init test");
				break;
			case 5:// Magical Attack 1:5
				...
				System.out.println("[MithrilDragons] Magical attack init test");
				break;
			}
