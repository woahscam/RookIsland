...
public class NPC extends Entity implements Serializable {
	...
	public void loadNPCSettings() {
		...
		if (getId() == 231 || getId() == 705 || getId() == 1861 || getId() == 4707 || getId() == 5195 || getId() == 4247) {
			setRandomWalk(0);
		}
		if (getId() == 650) {
	...
	public enum BossIds {
		...
		DAGANNOTH_REX(2883), TORMENTED_DEMON_1(8349), TORMENTED_DEMON_2(8350), TORMENTED_DEMON_3(8351), CHAOS_ELEMENTAL(3200);
			...
			if (killer.dropTesting) {
				for (int i = 0; i < killer.dropTestingAmount; i++) {
					...
					if (droppedItems == null) {
						killer.getPackets().sendGameMessage(getName() + " has no drops/contact Andreas");
						return;
					} else {
